"""
URL configuration for librospablo project.
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) #esto permite que las páginas estáticas se puedan cargar en desarrollo
